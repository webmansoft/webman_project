...
use app\common\model\system\SystemDeptLeaderModel;

class SystemDeptLeaderLogic extends BaseLogic
{
    public function __construct()
    {
        $this->model = new SystemDeptLeaderModel();
    }
